...
export const SWAGGER_TITLE = 'Delivery - Microsserviço de Auth';
...
export function buildSwaggerConfig(configService: ConfigService) {
  return new DocumentBuilder()
    ...
    .setDescription(
      `Cadastro de usuários e emissão de JWT. Pelo gateway, a interface fica em /auth/docs. Ambiente: ${configService.get<string>(
        'NODE_ENV',
        'development',
      )}`,
    )
